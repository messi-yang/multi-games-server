...
func NewGameModel(gameAggregate aggregate.Game) GameModel {
	return GameModel{
...
func (gameModel GameModel) ToAggregate() aggregate.Game {
	return aggregate.NewGame(gameValueObject.NewGameId(gameModel.Id), convertUnitModelBlockToUnitBlock(gameModel.UnitBlock))
}
